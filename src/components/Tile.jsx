...
const TILE_STYLES = {
  ...
  hard: [
    ...
    { backgroundColor: '#95a5a6', boxShadow: '0 0 10px #95a5a6', borderRadius: '20%' }, // Diamond
    { backgroundColor: '#f39c12', boxShadow: '0 0 10px #f39c12', borderRadius: '50%' }, // Obsidian
    { backgroundColor: '#d35400', boxShadow: '0 0 10px #d35400', borderRadius: '30%' }, // Garnet
    { backgroundColor: '#16a085', boxShadow: '0 0 10px #16a085', borderRadius: '50%' }, // Peridot
    { backgroundColor: '#8e44ad', boxShadow: '0 0 10px #8e44ad', borderRadius: '20%' }, // Tourmaline
    { backgroundColor: '#c0392b', boxShadow: '0 0 10px #c0392b', borderRadius: '50%' }, // Opal
    { backgroundColor: '#7f8c8d', boxShadow: '0 0 10px #7f8c8d', borderRadius: '30%' }, // Quartz
    { backgroundColor: '#2980b9', boxShadow: '0 0 10px #2980b9', borderRadius: '50%' }, // Jade
    { backgroundColor: '#8e44ad', boxShadow: '0 0 10px #8e44ad', borderRadius: '20%' }, // Lapis Lazuli
  ]
};

const Tile = ({ tileIndex, isPlaying, onClick, status, difficulty, showNumbers }) => {
  const baseStyle = {
